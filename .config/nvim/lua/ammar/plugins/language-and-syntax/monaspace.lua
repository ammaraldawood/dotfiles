return {
	...
	opts = {
		use_default = true,
		style_map = {
			-- Argon as Regular font being the most neutral (Default for all unmapped code)

			-- Xenon - Slab serif: documentation, comments, and structure
			bold = {
				Comment = true,
				Todo = true,
				SpecialComment = true,
			...
			-- Radon - Handwritten font: tentative thoughts, quotes, and links
			italic = {
				["@markup.raw.markdown"] = true,
				markdownUrl = true,
				htmlLink = true,
